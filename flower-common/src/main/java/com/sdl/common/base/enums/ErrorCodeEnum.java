package com.sdl.common.base.enums;

/**
 * @program flowerPaaS
 * @description: 错误枚举类
 * @author: songdeling
 * @create: 2019/12/23 14:00
 */
public enum ErrorCodeEnum {
     ...
     */
    GL99990401(99990401, "登录过期,请重新登录"),
    /**
     * Gl 000500 error code enum.
     */
    GL99990500(99990500, "服务器内部错误"),
    /**
    ...
    GL9999405(9999405, "脚本名已存在"),

    GL9999406(9999406, "操作文件错误"),
    /**
     ...
     */
    GL99990003(99990003, "操作数据库错误"),
    /**
     * Gl 99990003 error code enum.
     */
    GL99990004(99990004, "上传文件错误"),
    /**
     * Gl 99990007error code enum.
     */
    GL99990007(99990007, "写入文件出错"),
    /**
     * Gl 99990008error code enum.
     */
    GL99990008(99990008, "导出文件出错"),
    GL99990009(99990009, "ClobToString error"),
    GL99990010(99990010, "下载文件错误"),
    /**
...
//	 1001 用户中心
     ...
     */
    UAC10011043(10011043, "旧密码输入错误"),
    /**
     * Uac 10011044 error code enum.
     */
    UAC10011044(10011044, "用户名已存在"),
    /**
    ...
    /**
     * Uac 10012009 error code enum.
     */
    UAC10012009(10012009, "角色已存在"),
